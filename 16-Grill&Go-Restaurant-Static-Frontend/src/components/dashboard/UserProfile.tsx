...
const UserProfile = () => {
  ...
  const profilePicture = `https://ui-avatars.com/api/?name=${encodeURIComponent("Random")}&background=4ade80&color=fff&size=128`;
      ...
      <div className="max-w-4xl mx-auto rounded-lg shadow-lg p-5">
        <div className="flex flex-col md:flex-row items-center justify-between border-b border-gray-700 pb-5 mb-5">
          <div className="relative flex items-center gap-4 mb-4 md:mb-0">
            ...
            <div>
              <h2 className="text-3xl font-bold text-orange-600">Denis</h2>
              <p className="text-green-600">denis@mail.com</p>
            </div>
          </div>
          <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-gradient-to-r from-orange-600 to-amber-600 rounded-lg p-4">
            ...
            <p className="mb-2">
              <span className="font-bold">First Name:</span> Denis
            </p>
            <p className="mb-2">
              <span className="font-bold">First Name:</span> Wachira
            </p>
          </div>
          <div className="bg-gradient-to-r from-orange-600 to-amber-600 rounded-lg p-4">
