...
export const SideNav =()=> {
    return (
        <ul className="menu bg-gray-300 text-dark-300 shadow-lg min-w-full gap-2 text-base-content min-h-full">
            ...
            <li>
                <Link to="me"><SquareUserRound className=" text-green-600"/>My Profile</Link>
            </li>
            <li>
                <Link to="orders"><FaShop className=" text-green-600"/>Order</Link>
            </li>
            <li>
                <Link to="payments"><FaDollarSign className=" text-green-600"/>Payments</Link>
            </li>
            <li>
